...
public class ClienteResource {
	...
	public ResponseEntity<Void> atualize(@Valid @RequestBody ClienteDTO clienteDTO, @PathVariable Integer id){
		Cliente cliente = clienteService.fromDTO(clienteDTO);
		cliente.setId(id);
		cliente = clienteService.atualize(cliente);
	...
	public ResponseEntity<List<ClienteDTO>> consulteListaClientes() {
		List<Cliente> clientes = clienteService.consulteListaClientes();
